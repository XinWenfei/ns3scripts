...
NS_LOG_COMPONENT_DEFINE ("APCSMAEXT2");
...
int main(int argc, char *argv[])
{
    ...
    if (verbose)
    {
      ...
      LogComponentEnable ("APCSMAEXT2", LOG_LEVEL_INFO);
    }
    ...
    UdpEchoClientHelper echoClient (wn2intf.GetAddress (wn2intf.GetN()-2), 9);
    ...
    if(tracing == true){
        csma.EnablePcapAll("pcap/apcsmaext2");
        phy.EnablePcapAll("pcap/apcsmaext2");
    }

    AnimationInterface anim("xml/apcsmaext2");
