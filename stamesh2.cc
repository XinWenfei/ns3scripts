...
int main(int argc, char* argv[])
{
   ...
   if(pcap)
        phy.EnablePcapAll(std::string("pcap/stamesh2"));
    ...
    //ptr_staticRotingAp0->AddHostRouteTo(ipAp1, ipMesh0, 2, 0);
    ////ptr_staticRotingAp0->SetDefaultRoute(ipAp0, 1, 0);
    //Ipv4RoutingTableEntry routeTable = ptr_staticRotingAp0->GetRoute(1);
    ...
    UdpEchoClientHelper echoClient(net2intf.GetAddress(1), 9);
    ...
    AnimationInterface anim("xml/stamesh2.xml");
