...
//	cout << "mobility model is:" << ptr_mm << endl;
    ...
    ptr_staticRouting = staticRouting.GetStaticRouting(net1nc.Get(0)->GetObject<Ipv4>());
    ptr_staticRouting->AddNetworkRouteTo(Ipv4Address("192.168.2.0"), Ipv4Mask("255.255.255.0"), Ipv4Address("192.168.1.2"), 1, 0);
    ptr_staticRouting = staticRouting.GetStaticRouting(net2nc.Get(1)->GetObject<Ipv4>());
